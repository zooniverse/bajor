...
setuptools.setup(
    ...
    install_requires=[
        ...
        # temp workaround till https://github.com/mwalmsley/zoobot/pull/75 is merged to for-v1
        'zoobot[pytorch_cu113] @ git+https://github.com/mwalmsley/zoobot.git@multi-image-catalogs',
