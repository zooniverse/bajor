from bajor.training.batch import schedule_job, create_batch_job, create_job_tasks, active_jobs_running
import uuid, os
from unittest import mock

fake_job_id = str(uuid.uuid4())

@mock.patch('bajor.training.batch.get_batch_job_list')
...
@mock.patch('bajor.training.batch.create_batch_job')
@mock.patch('bajor.training.batch.create_job_tasks')
